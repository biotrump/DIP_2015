...
function minDist(train, tbb, sample, sbb)
	...
	for i=1:nsbb
		...
		for j=1:ntbb
			...
			temp=(sA0-tA0)^2+(sAa(1)-tAa(1))^2+(sAa(2)-tAa(2))^2+...
				(sP-tP)^2+(sPa(1)-tPa(1))^2++(sPa(2)-tPa(2))^2+...
				(sE4-tE4)^2 +(sE8-tE8)^2+(sLa(1)-tLa(1))^2+(sLa(2)-tLa(2))^2+...
